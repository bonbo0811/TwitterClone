<div class="tweet">
    ...
    <div class="content">
        ...
        <div class="icon-list">
            <div class="like js-like" data-tweet-id="<?php echo htmlspecialchars($view_tweet['tweet_id']); ?>" data-like-id="<?php echo htmlspecialchars($view_tweets['like_id']); ?>">
                <?php 
                    if (isset($view_tweets['like_id'])){
                         //いいね！している場合は青のハートを表示
                        echo '<img src="'. HOME_URL.'views/img/icon-heart-twitterblue.svg" alt="">';
                    } else{
                        //いいね！してない場合はグレーのハートを表示
